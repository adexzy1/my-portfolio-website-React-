        ...
        <div className="grid">
          <article className="card animate-on-scroll">
            <div className="card-content">
              ...
              <p className="card-desc">
                Learn how to create maintainable design systems that grow
                with your product and team. A comprehensive guide to tokens,
          ...
          <article className="card animate-on-scroll">
            <div className="card-content">
              ...
              <p className="card-desc">
                Exploring the latest patterns and best practices in React
                development, from server components to advanced state
          ...
          <article className="card animate-on-scroll">
            <div className="card-content">
              ...
              <p className="card-desc">
                Discover how subtle animations and feedback mechanisms can
                dramatically improve user experience and product delight.
              </p>
              <a href="#" className="read-more">
                Read More â†’
              </a>
